...
export const organizationsData: IOrganizationsData[] = [
	{
		...
		balanceAccounts: '835 783 222.64',
	},
	{
		id: '12',
		shortName: 'Археопоиск ООО',
		fullName: 'ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "АРХЕОПОИСК"',
		type: 'Юридическое лицо',
		inn: '5262390741',
		ogrn: '1235200008977',
		accounts: ['4803', 'Сбер8594', 'МЦАИ 0700'],
	...
	},
	{
		...
		fullName: 'ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "АРХ-ПРОЕКТ"',
		type: 'Юридическое лицо',
		inn: '6829153377',
		ogrn: '1206800000593',
		accounts: ['4803', 'Сбер8594', 'МЦАИ 0700'],
